      ...
      {tab==="overview"&&<>
        ...
        {businessInsights&&<>
          <section className="analyticsGrid">
            <div className="panel"><div className="panelHead"><div><h3>Hourly sales curve</h3><p>Fulfilled revenue by invoice hour · complete AED 108,172.75 coverage.</p></div><Badge tone="good">Peak {businessInsights.operatingHighlights.peakHour.label}</Badge></div>
          ...
          <section className="analyticsGrid">
            <div className="panel wide"><div className="panelHead"><div><h3>Daily revenue trend</h3><p>Click headers in the table below to identify strongest and weakest dates.</p></div><Badge tone="good">30 DAYS</Badge></div>
              ...
              <DataGrid id="daily-performance" rows={businessInsights.daily} columns={[
                {key:"date",label:"Business date"},{key:"day",label:"Day"},{key:"orders",label:"Orders",numeric:true},{key:"guests",label:"Guests",numeric:true,defaultVisible:false},{key:"revenue",label:"Revenue",numeric:true,render:x=>money(x.revenue)},{key:"discount",label:"Discount",numeric:true,render:x=>money(x.discount)},{key:"vat",label:"VAT",numeric:true,defaultVisible:false,render:x=>money(x.vat)},{key:"averageCheck",label:"Avg check",numeric:true,render:x=>money(x.averageCheck)},{key:"firstActivity",label:"First bill",defaultVisible:false},{key:"lastActivity",label:"Last bill",defaultVisible:false},{key:"observedWindowMinutes",label:"Observed window",numeric:true,defaultVisible:false,render:x=>minutesLabel(x.observedWindowMinutes)}
            ...
            <div className="panel wide compactWeekly"><div className="panelHead"><div><h3>Week-by-week control</h3><p>Revenue, orders and discount pressure across the month.</p></div></div>
