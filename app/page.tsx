      ...
      {tab==="overview"&&<>
        ...
        <section className="developerControlPanel">
          ...
          <div className="issueMap"><div className="panelHead"><div><h3>Developer root-cause map</h3><p>What users see, where the data breaks, and the required control.</p></div><Badge tone="bad">3 CORE FAILURES</Badge></div>
            <button onClick={()=>setTab("items")}><em>ITEM / CATEGORY</em><b>TMBill loses AED 13 original gross</b><span>Zero price + discount representation breaks item/category totals.</span><strong>Persist original price + Complimentary event →</strong></button>
            <button onClick={()=>setTab("payments")}><em>PAYMENT / TAX EXPORT</em><b>AED 1,181.90 secondary tenders omitted</b><span>Invoice totals pass; tender-component columns do not.</span><strong>Explode invoice × tender allocations →</strong></button>
